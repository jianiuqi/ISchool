...
import com.ibm.ischool.base.BaseApplication;
...
public class CrashHandler implements UncaughtExceptionHandler{
    ...
    private String getFilePath() {  
        ...
        if (isSDCardExist && isRootDirExist) {  
            file_dir = Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + Constant.APP_FOLDER_NAME +"/crashlog/";  
        } else {  
            // MyApplication.getInstance().getFilesDir()返回的路劲为/data/data/PACKAGE_NAME/files，其中的包就是我们建立的主Activity所在的包  
            file_dir = BaseApplication.getAppInstance().getFilesDir().getAbsolutePath() + "/" + Constant.APP_FOLDER_NAME + "/crashlog/";
        }  
        return file_dir;
    }  
    /** 
